...
<head>
  ...
  <link rel="stylesheet" href="<?= htmlspecialchars(app_url('assets/app.css')) ?>?v=6">
</head>
<body>
<header class="topbar">
  <div class="brand">
...
<script src="<?= htmlspecialchars(app_url('assets/keyboard.js')) ?>?v=6"></script>
<script src="<?= htmlspecialchars(app_url('assets/device-preferences.js')) ?>?v=6"></script>
<script src="<?= htmlspecialchars(app_url('assets/kiosk.js')) ?>?v=6"></script>
</body>
</html>
